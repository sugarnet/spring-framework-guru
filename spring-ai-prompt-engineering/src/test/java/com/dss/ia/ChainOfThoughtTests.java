...
class ChainOfThoughtTests extends BaseTestClass {
    ...
    @Test
    void testTraditionalPromptSpanish() {
        String prompt = """
                Q: Esteban tiene 5 pelotas de tenis. Él compra 2 latas de pelotas, cada lata tiene 3 pelotas. \s
                ¿Cuantas pelotas de tenis tiene Esteban en total? Responder la pregunta con solo una palabra. 
                """;
