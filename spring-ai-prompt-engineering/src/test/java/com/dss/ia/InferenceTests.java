...
class InferenceTests extends BaseTestClass {
    ...
    String review4 = """
            Había leído comentarios de otro comprador que tuvo el mismo problema, en la publicación específica que es de 40 Oz y te llega uno de 30 oz, el producto es de buena calidad pero no es lo que se específica en la publicación""";
